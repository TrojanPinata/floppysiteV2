      ...
      return (
         <div className="App">
            <div className="proj">
               ...
               <p>This was one of two projects for my linear electronics course which entailed designing an amplifier using NMOS in order to satisfy a pretty strict set of criteria. This is one of those projects where explaining too much might be a problem, so I will pretty shortly say that it was a fun project which mostly revolved around cascading amplifiers and very weird results in Pspice.</p>

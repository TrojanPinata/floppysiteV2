...
class Lighting extends Component {
   render() {
      return (
         <div className="proj">
            <h3>Here's the thing about my lights...</h3>
            <p>So let's get this straight first. Why do I care about my lights so much?</p>

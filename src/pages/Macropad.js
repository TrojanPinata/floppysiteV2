         ...
         <div className="App">
            <div className="proj">
               ...
               <Fade bottom duration={1200}>
                  ...
                  <p>Because of these things, I wanted to design a simple 12-key macropad which represents the F13-F24 keys and can be put together with a bit of soldering skill and access to any volume 3D printer. As pictured, the switchplate and case can both be printed on a Prusa Mini and put together using glue or M2 screws. The PCB can be bought from JLC for ~$12 or handwired, using the schematics provided in KiCad. I wanted to make the entire system accessable for anyone with different levels of access without requiring them to make modifications to my designs.</p>
                  <p>I've listed the materials and a short guide on <a href="https://github.com/TrojanPinata/Macropad-Pico">GitHub</a> as well as a <a href="https://youtu.be/6qyvscmvLPk">short video guide</a>. I hope this will make getting into the manufacturing side of the keyboard hobby easier, as well as act as a introduction for some people into soldering and possibly CAD through modifying my designs for further customization.</p>
